...
router.use("/materials",authMiddleware.verifyToken, materialRouter);
router.use("/colors", authMiddleware.verifyToken, colorRouter);
router.use("/sizes", authMiddleware.verifyToken, sizeRouter);
